...
from .models import ExecutionContext, IncidentInput
from .observability import configure_logging
from .persistence import JsonRunStateRepository
from .providers.mock import MockProvider
from .workflow import Workflow

app = typer.Typer(help="Data Pipeline Failure RCA Agent")
...
def run(
    ...
    try:
        request = IncidentInput.model_validate_json(input_file.read_text(encoding="utf-8"))
