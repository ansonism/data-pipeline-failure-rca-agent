...
from pipeline_rca.models import EvidenceInput, IncidentInput, RunStatus
from pipeline_rca.persistence import InMemoryRunStateRepository
from pipeline_rca.providers.mock import MockProvider
from pipeline_rca.workflow import DEFAULT_STAGES, Workflow

NOW = datetime(2026, 1, 1, tzinfo=UTC)


def request() -> IncidentInput:
